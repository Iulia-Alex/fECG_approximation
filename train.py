...
if __name__ == "__main__":
    ...
    batch_size = 30
    epochs = 10
    # data_path = "/home/iulia/Desktop/iulia/Licenta/unet/ecg/"
    current_dir = os.path.dirname(os.path.abspath(__file__))
    data_path = os.path.join(current_dir, "ecg")

    # model_save_path = "/home/iulia/Desktop/iulia/Licenta/unet/models/unet.pth"
    model_save_path = os.path.join(current_dir, "models", "unet1.pth")
